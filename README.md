<div align="center">
  <h1>✨ RavenKit</h1>
  <p>A modern, opinionated React starter with Vite, TypeScript, and shadcn/ui</p>
...
- 🎨 **Beautiful UI** - Pre-configured with shadcn/ui components
- 🌓 **Dark Mode** - Built-in dark/light theme support
- 🛠 **Developer Experience** - ESLint, Prettier, and TypeScript out of the box
- 📱 **Responsive** - Mobile-first approach with Tailwind CSS
- 🔄 **Modern Stack** - React 18, Vite 5, and TypeScript 5
